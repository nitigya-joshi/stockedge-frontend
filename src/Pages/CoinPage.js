...
export default function CoinPage() {
  ...
  const imageUrl=idToUrl[coin.id]
    const indicesText=(coin.id=="nifty50" || coin.id=="sensex")?"/indices":"";
  return (
   
    <div id="coinPageContainer">
      <div id="coinDescriptionSidebar">
        <img src={`https://s3-symbol-logo.tradingview.com${indicesText}/${imageUrl}.svg`}  id="sidebarImg" alt={coin?.name} />
